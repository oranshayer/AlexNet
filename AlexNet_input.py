...
def read_AlexNet(filename_queue):
  """Reads and parses examples from AlexNet data files.
  ...
  class AlexNetRecord(object):
    pass
  result = AlexNetRecord()
...
#  tf.scalar_summary('label_batch', label_batch[0][0])
...
#      raise ValueError('Failed to find file: ' + f)
  ...
  read_input = read_AlexNet(filename_queue)
...
#  float_image = (distorted_image - pixelMean)/255
